...
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `vickvaporub` ;
USE `vickvaporub` ;

-- -----------------------------------------------------
-- Table `vickvaporub`.`tb_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vickvaporub`.`tb_cliente` (
...
-- -----------------------------------------------------
-- Table `vickvaporub`.`tb_produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vickvaporub`.`tb_produto` (
...
-- -----------------------------------------------------
-- Table `vickvaporub`.`tb_venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vickvaporub`.`tb_venda` (
  ...
  CONSTRAINT `fk_tb_venda_tb_produto1`
    ...
    REFERENCES `vickvaporub`.`tb_produto` (`idproduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
